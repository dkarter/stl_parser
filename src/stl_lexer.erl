-file("/Users/dorian/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("src/stl_lexer.xrl", 27).

-file("/Users/dorian/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(50, [10|Ics], Line, Tlen, _, _) ->
    yystate(50, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(48, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(48, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(48, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 110 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(48, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 114 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
yystate(48, [C|Ics], Line, Tlen, Action, Alen) when C >= 119, C =< 122 ->
    yystate(22, Ics, Line, Tlen+1, Action, Alen);
...
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 107 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 114 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 110 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 122 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(29, Ics, Line, Tlen, _, _) ->
    {7,Tlen,Ics,Line,29};
yystate(28, [121|Ics], Line, Tlen, _, _) ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(28, [122|Ics], Line, Tlen, _, _) ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(28, [120|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line, Tlen+1, 7, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 119 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(22, Ics, Line, Tlen+1, 7, Tlen);
...
-file("src/stl_lexer.xrl", 14).
yyaction_0(TokenChars, TokenLine) ->
     { token, { defsolid, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/stl_lexer.xrl", 15).
yyaction_1(TokenChars, TokenLine) ->
     { token, { endsolid, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/stl_lexer.xrl", 16).
yyaction_2(TokenChars, TokenLine) ->
     { token, { deffacet, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/stl_lexer.xrl", 17).
yyaction_3(TokenChars, TokenLine) ->
     { token, { endfacet, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/stl_lexer.xrl", 18).
yyaction_4(TokenChars, TokenLine) ->
     { token, { defouterloop, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/stl_lexer.xrl", 19).
yyaction_5(TokenChars, TokenLine) ->
     { token, { endloop, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("src/stl_lexer.xrl", 20).
yyaction_6(TokenChars, TokenLine) ->
     { token, { defvertex, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/stl_lexer.xrl", 21).
yyaction_7(TokenChars, TokenLine) ->
     { token, { keyword, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("src/stl_lexer.xrl", 22).
yyaction_8(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_9/0}).
-file("src/stl_lexer.xrl", 23).
yyaction_9() ->
     skip_token .

-file("/Users/dorian/.asdf/installs/erlang/22.0.7/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
